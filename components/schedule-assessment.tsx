...
>
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
    <div className="bg-white rounded-xl shadow-2xl w-[450px] max-w-[90%] p-10 text-center">
      ...
      <button
        ...
        className="px-8 py-3 rounded-md bg-[#2d5184] text-white hover:bg-[#23426c] transition"
      >
        Close
      </button>
    </div>
